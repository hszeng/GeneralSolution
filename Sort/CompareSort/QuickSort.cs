...
namespace Introduction2Algorithms.Sort
{
    public class QuickSort<T> : ISort<T> where T : IComparable<T>
    {
        ...
        //    {
        //        int pivot = Partition(array, startIndex, endIndex);
        //        Parallel.Invoke(() => ParallelSort(array, startIndex, pivot - 1), () => ParallelSort(array, pivot + 1, endIndex));
        //    }
        //}
        ////改进的并行快排，当元素小于一定值时，采取插入排序
        //public static void ImprovedParallelQuickSort(int[] array, int startIndex, int endIndex)
        //{
        //    if (startIndex < endIndex)
        //    {
        //        if (endIndex - startIndex <= (endIndex - startIndex) / 1000)
        //        {
        //            InsertionSort.Sort(array, startIndex, endIndex);
        //            return;
        //        }
        //        int pivot = Partition(array, startIndex, endIndex);
        //        Parallel.Invoke(() => ImprovedParallelQuickSort(array, startIndex, pivot - 1), () => ImprovedParallelQuickSort(array, pivot + 1, endIndex));
        //    }
        //}     
    }
}
